...
modelo='FotosMusk'
ruta1='C:/Users/uilia/Desktop/Programas/PythonCourseFacialRecognition/reconocimientofacial1/data'
rutacompleta=ruta1+'/'+modelo
if not os.path.exists(rutacompleta):
    os.makedirs(rutacompleta)
    print('Carpeta creada:',modelo)

camara=cv2.VideoCapture("reconocimientofacial1/data/videos/ElonMusk.mp4")
